...
Read [.harness/README.md](.harness/README.md) before changing or verifying this repository. It is the canonical harness guide for Codex and other coding agents. The executable entry point is `scripts/verify.py`:
